...
VALUES('$title', '$link', '$lin', '$about', '$artname', '$feature', '0', '$date', '$audiomack', ' ', '$artname', 'YES', 'ON')";

mysql_query($insert);

$take = "SELECT * FROM music_upload WHERE name='$title' AND main='$artname' AND about='$about'";
$runquery = mysql_query($take);

while($pix = mysql_fetch_array($runquery)){
    $item = $pix["id"];

//INSERT INTO SOLD TABLE
$sold = "INSERT INTO premium (item_id, price, reg_date) VALUES('$item', '400', '$date')";
mysql_query($sold);
