...
<title>Admin Area - Talk Zone</title>
<body>
...
<div class="sect">
<div class="top"><center><h2>Manage Talk Zone</h2></center></div>
</br>
<div class="type">

<?php
$sng = "SELECT * FROM news WHERE article_type='talk-zone' ORDER BY id DESC";
$res = mysql_query($sng);
