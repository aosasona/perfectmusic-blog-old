...
$insert = "INSERT INTO music_upload (name, link, thumb, about, main, feature, downloads, updated, audiomack, music_type, author) 
VALUES('$title', '$link', '$lin', '$about', '$artist', '$feature', '0', '$date', '$audiomack', ' ', '$username')";
...
if($type == "mix") {
    ...
    //Insert data into database
    $insert = "INSERT INTO music_upload (name, link, thumb, about, main, feature, downloads, updated, audiomack, music_type, author) 
    VALUES('$title', '$link', '$lin', '$about', '$artist', '$feature', '0', '$date', '$audiomack', 'mix', '$username')";
...
if($type == "pm-list") {
    ...
    echo '<meta http-equiv="refresh" content="2, url=/editor/main.php">';
