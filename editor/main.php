...
echo '</br></br>Signed In As : <b>'.$_SESSION["editor"].'</b><a href="reset.php"><b><i><small><font color="red">(LOGOUT)</font></small></i></b></a>';
?>

</br></br>
<center>
<div class="sect">
<div class="topm"><center><h2>File Upload Center</h2></center></div>
</br>
<div class="type">
If your file is large, please be patient with the upload process and ensure you have a strong network connection!
</br>

<form action="/editor/fetch.php" method = "POST" enctype="multipart/form-data">
</br></br>
...
<b>Select the MAIN audio/image/video/file you want to upload</b> : 
